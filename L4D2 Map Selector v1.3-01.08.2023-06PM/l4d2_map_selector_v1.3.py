...
def welcome_user(ver_file="ver.txt", build_version="v1.3-01.08.2023-06PM"):
...
class very_usseful_func:
    ...
    def __init__(self, command=None, name_of_window=None):
...
class Generic_func:
    ...
    def quitting_program():
        ...
        if quit_program == "yes":
            ...
            very_usseful_func().os_popen(WMIC_COMAND)
        ...
        if is_launched.find(GAME) != -1:
            ...
            while True:
                ...
                if maxi:
                    ...
                    print(time_spin_stop - time_spin_start)
                    ...
                    with open(spin_time_determination, "a",
                        ...
                        final_result_determination.seek(78)
...
width=20, command=Generic_func.quitting_program, style="Quit_Program.TButton")
button_quit_prog.grid(row=8 ,column=0)

button_Credits = ttk.Button(tab1, text="Credits", width=15, command=Generic_func.credits,
