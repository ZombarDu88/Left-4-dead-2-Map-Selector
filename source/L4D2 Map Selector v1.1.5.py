...
def Start_L4D2(Succes_start_cmd="\033[1;32mleft4dead2.exe is succefully started\n\033[1;32msucces detect: left4dead2.exe\033[0;37m"):
	...
	if L4D2_is_launched.find("left4dead2.exe") != -1:
		...
		try:
			if Partition.find("C:"):
				CMD.restore()
				print("Whait... testing -> C:/Users/"+User+"/AppData/Roaming/Microsoft/Windows/Start Menu/Programs/Steam/Left 4 Dead 2.url")
				...
				CMD.restore()
				print("Whait... testing -> D:/Users/"+User+"/AppData/Roaming/Microsoft/Windows/Start Menu/Programs/Steam/Left 4 Dead 2.url")
