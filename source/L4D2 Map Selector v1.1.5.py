...
buttom_check = tkinter.Button(mainapp, text="Minimize cmd", width=20, command=Hide_cmd)
buttom_check.pack()

buttom_check = tkinter.Button(mainapp, text="Show cmd", width=15, command=Show_cmd)
buttom_check.pack()
...
button_Credits = tkinter.Button(mainapp, text="Credits", width=20, command=Credits)
button_Credits.pack()

buttom_quit = tkinter.Button(mainapp, text="Quit Program", width=15, bg="#ff0000", command=Quitting_Program)
buttom_quit.pack()
