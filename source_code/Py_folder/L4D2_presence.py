...
def Discord_Rpc():
	...
	if output_discord.find("Discord.exe") != -1:
		...
		try:
			...
			Rpc.update(details="ver: v1.2-19.04.2023-08PM", state="Credits: NoNoDu88, FoxTroT, Kef", large_image="l4d2_map_selector_icon", start=epoch_time,
			buttons=[{"label": "The Program\U0001F40D (1.2)" , "url": "https://github.com/ZombarDu88/Left-4-dead-2-Map-Selector"}])
